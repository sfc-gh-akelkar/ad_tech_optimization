...
GRANT CREATE AGENT ON SCHEMA PATIENTPOINT_DB.IXR_ANALYTICS TO ROLE SF_INTELLIGENCE_DEMO;
GRANT USAGE ON WAREHOUSE COMPUTE_WH TO ROLE SF_INTELLIGENCE_DEMO;
...
SHOW AGENTS IN SCHEMA PATIENTPOINT_DB.IXR_ANALYTICS;
...
GRANT USAGE ON DATABASE PATIENTPOINT_DB TO ROLE SF_INTELLIGENCE_DEMO;
GRANT USAGE ON SCHEMA PATIENTPOINT_DB.IXR_ANALYTICS TO ROLE SF_INTELLIGENCE_DEMO;
GRANT SELECT ON ALL TABLES IN SCHEMA PATIENTPOINT_DB.IXR_ANALYTICS TO ROLE SF_INTELLIGENCE_DEMO;
GRANT SELECT ON ALL VIEWS IN SCHEMA PATIENTPOINT_DB.IXR_ANALYTICS TO ROLE SF_INTELLIGENCE_DEMO;
GRANT SELECT ON SEMANTIC VIEW PATIENT_IMPACT_SEMANTIC_VIEW TO ROLE SF_INTELLIGENCE_DEMO;
